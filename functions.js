...
const perimetroCirculoFlecha = (radio) =>{return 2*piNumber*radio}
/*
...
const areaRectanguloFlecha = (ancho, largo) =>{return ancho*largo}
/*
...
function volumenEsfera(radio){
    return (4/3)*piNumber*radio**3} 

const volumenEsferaFlecha = (radio) =>{return (4/3)*piNumber*radio**3}
/*
 * 
